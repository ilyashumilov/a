...
class TaskCreator:
    ...
    def __choose_methods(cls, parsing_task_blogger):
        cls.profile_info(parsing_task_blogger)
        cls.posts(parsing_task_blogger)
        cls.subscribers(parsing_task_blogger)
        cls.comments(parsing_task_blogger)
    ...
    @classmethod
    def profile_info(cls, parsing_task_blogger: ParsingTaskBlogger):
        task_type = ParsingTaskTypeName.profile_info
        data = [parsing_task_blogger.blogger.social_or_login]
    ...
    @classmethod
    def filtering_bloggers(cls, parsing_task_blogger: ParsingTaskBlogger, array: list, chunks_support=True):
